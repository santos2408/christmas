(function () {
  ...
  gsap.set(c, { transformOrigin: "100% 100%", y: -100 });
  ...
  // sparkles effect
  (function () {
    k = gsap.timeline({ onUpdate: segundaFuncao });
